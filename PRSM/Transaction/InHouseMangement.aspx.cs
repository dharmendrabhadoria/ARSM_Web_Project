...
public partial class Transaction_InHouseMangement :PageBase
{
    ...
    {
        DataSet dsGetWorkOrderData = objTRANSBAL.GetWorkOrder(0,0, Convert.ToInt32(ddlCustomer.SelectedValue), Convert.ToInt32(ddlWareHouse.SelectedValue), istatus, null, null);
        ddlWorkOrder.Items.Clear();
    ...
    protected void ddlCustomer_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (ddlCustomer.SelectedIndex > 0)
        {
            ...
            bindWorkOrder(icustomerid, iwarehouseid, istatus);
        }
        else
        {
            ddlWorkOrderActivity.Items.Clear();
    ...
    protected void bindWorkOrder(int icustomerid, int iwarehouseid, int istatus)
    {
        DataSet dsWorkOrder = objTRANSBAL.GetWorkOrder(0, 0,icustomerid, iwarehouseid, istatus, null, null);
        ddlWorkOrder.Items.Clear();
        ddlWorkOrder.DataSource = null;
        ddlWorkOrder.DataBind();
        if (dsWorkOrder != null)
    ...
    protected void ddlWorkOrder_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        DataSet dsWorkOrderActivity = objTRANSBAL.GetWoActivity(0, Convert.ToInt32(ddlWorkOrder.SelectedValue), istatus, "In House Management",0);
        if (ddlCustomer.SelectedIndex > 0)
        {
    ...
    public void SetRolewiseAcessfuncationality()
    {
        ...
        DataTable dtPageId = objUserRoleWiseAcessDAL.GetApplicationCodeDetails("Page_Name", "In House Management").Tables[0];
        int PageId = 0;
