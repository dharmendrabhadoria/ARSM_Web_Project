...
Select count(*) From tbl_BoxDetails  --4727
Select count(*)  From tbl_FileDetails  -- select 60092
Select count(*) From tbl_FileTransactions  -- select 60386
Select * From tbl_WoActivities Where n_WorkOrderNo=2015000083 -- 3 rows 
--boxes against these woactivities
select * from tbl_BoxTransactions where n_WoActivityId in ( 361,362,363)   -- 0 boxes 
...
Where TB.n_WoActivityId in ( 361,362,363)      
...
alter table wo_2015000083 add  DeptId smallint
update wo_2015000083 set [FROM DATE] = null,[TO DATE]=null;
insert tempdata 
select * from wo_2015000083
...
insert into tbl_applicationcodemaster(s_appcode,s_appcodename)
select 'DEPARTMENT','B2B Business '
