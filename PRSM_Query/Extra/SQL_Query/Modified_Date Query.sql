select * from tbl_workorder where n_WorkorderNo = 2015000105

--begin tran
--update tbl_workorder set d_WoDate = '2015-10-14 00:00:00.000' ,d_ModificationDate = '2015-10-14 15:41:07.510'  where n_WorkorderNo = 2015000105
--commit

select * from tbl_WoActivities where n_WorkorderNo = 2015000105 
--n_WoActivityId in(438,439,440)

--begin tran
--update tbl_WoActivities set d_ModificationDate = '2015-10-14 15:41:07.517' ,d_ActivityDate = '2015-10-14 00:00:00.000' where n_WorkorderNo = 2015000105
--commit

select * from tbl_FileTransactions where n_WoActivityId in(438,439,440)
--6145 rows

--begin tran
--update tbl_FileTransactions set d_ModifiedDate = '2015-10-14 11:08:07.503'  where n_WoActivityId in(438,439,440)
--commit
...
where  n_WoActivityId in(438,439,440)
--6145 rows
...
select * from tbl_BoxTransactions   where n_WoActivityId in(438,439,440)
--1000 rows

--begin tran
--update tbl_BoxTransactions set d_ModifiedDate = '2015-10-14 11:08:07.503'  where n_WoActivityId in(438,439,440)
--commit
